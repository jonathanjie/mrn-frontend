    ...
    <div class="grid lg:grid-cols-2 bg-white rounded-lg p-5 gap-4">
        ...
        <div class="grid col-span-2 lg:col-span-1 grid-cols-5 border">
            ...
            <div class="flex col-span-3 p-2 pl-4 border-b bg-white">
                <input v-model="heavyWeatherCondition.hours" @keypress="preventNaN($event, heavyWeatherCondition.hours)" placeholder="00.0" class="w-24 text-14 text-gray-700 focus:outline-0"/>
                <MiniUnitDisplay>HRS</MiniUnitDisplay>
            </div>
            <div class="col-span-2 text-blue-700 p-3 border-r border-b bg-gray-50 text-14">{{ $t("distance") }}</div>
            <div class="flex col-span-3 p-2 pl-4 border-b bg-white">
                <input v-model="heavyWeatherCondition.dist" @keypress="preventNaN($event, heavyWeatherCondition.dist)" placeholder="00.0" class="w-24 text-14 text-gray-700 focus:outline-0"/>
            ...
            <div class="flex col-span-3 p-2 pl-4 bg-white">
                <input v-model="heavyWeatherCondition.consumption" @keypress="preventNaN($event, heavyWeatherCondition.consumption)" placeholder="00.0" class="w-24 text-14 text-gray-700 focus:outline-0"/>
        ...
        <div class="col-span-2 grid grid-cols-10 border">
            ...
            <input v-model="heavyWeatherCondition.wind_direction" @keypress="preventNaN($event, heavyWeatherCondition.wind_direction)" placeholder="000 (Degrees)" class="col-span-6 lg:col-span-2 p-3 pl-4 border-b lg:border-b-0 lg:border-r bg-white text-14 text-gray-700 focus:outline-0"/>
            <div class="col-span-4 lg:col-span-1 text-blue-700 p-3 border-r bg-gray-50 text-14">{{ $t("force") }}</div>
            <select v-model="heavyWeatherCondition.wave_force" class="col-span-6 lg:col-span-3 p-3 text-14 focus:border-0" :class="heavyWeatherCondition.wave_force === 'default' ? 'text-gray-400' : 'text-gray-700'">
        ...
        <div class="col-span-2 lg:col-span-1 grid grid-cols-5 border">
            ...
            <div class="flex col-span-3 p-2 pl-4 border-l bg-white">
                <input v-model="heavyWeatherCondition.max_wave_ht" @keypress="preventNaN($event, heavyWeatherCondition.max_wave_ht)" placeholder="00.0" class="w-24 text-14 text-gray-700 focus:outline-0"/>
...
const heavyWeatherCondition = reactive({
