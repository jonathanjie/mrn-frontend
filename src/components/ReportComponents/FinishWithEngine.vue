		...
		<div class="col-span-2 lg:col-span-1 grid grid-cols-5 border bg-white text-14 mb-5">
			...
			<div class="col-span-3 flex flex-col space-y-2 p-3 text-gray-700">
				<div class="flex align-center space-x-2">
					<input type="radio" id="anchoringStartOutside" value="0" v-model="data.status">
					<label for="anchoringStartOutside">{{ $t("anchoringStartOutside") }}</label>
				</div>
				<div class="flex align-center space-x-2">
					<input type="radio" id="anchoringStartInside" value="1" v-model="data.status">
					<label for="anchoringStartInside">{{ $t("anchoringStartInside") }}</label>
				</div>
				<div class="flex align-center space-x-2">
					<input type="radio" id="driftingStart" value="2" v-model="data.status">
					<label for="driftingStart">{{ $t("driftingStart") }}</label>
				</div>
				<div class="flex align-center space-x-2">
					<input type="radio" id="berthingStart" value="3" v-model="data.status">
