<template>
    <div class="grid bg-white rounded-lg p-5 gap-4 divide-y divide-dashed shadow-card">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div class="col-span-2 lg:col-span-1 grid grid-cols-5 border bg-gray-50">
                ...
                <input v-model="rupEngine.lat_degree" 
            ...
            <div class="col-span-2 lg:col-span-1 grid grid-cols-5 border bg-gray-50">
                ...
                <input v-model="rupEngine.long_degree" 
                    @keypress="preventNaN($event, rupEngine.long_degree)" 
                    placeholder="000 (Degree)" 
                    class="col-span-3 p-3 pl-4 border-l border-b bg-white text-14 text-gray-700 focus:outline-0"
                />
                <input v-model="rupEngine.long_minutes" 
                    @keypress="preventNaN($event, rupEngine.long_minutes)" 
                    placeholder="000 (Minutes)" 
                    class="col-span-3 p-3 pl-4 border-l border-b bg-white text-14 text-gray-700 focus:outline-0"
                />
                <select v-model="rupEngine.long_dir" 
                    class="col-span-3 p-3 text-14 border-l focus:border-0" 
                    :class="rupEngine.long_dir === 'default' ? 'text-gray-400' : 'text-gray-700'"
                >
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="col-span-2 lg:col-span-1 grid grid-cols-5">
                ...
                <div class="col-span-2 text-blue-700 p-3 border-l border-t lg:border-y bg-gray-50 text-14">{{ $t("setRPMofME") }}</div>
                <div class="flex col-span-3 lg:col-span-3 p-2 pl-4 border-x border-t lg:border">
