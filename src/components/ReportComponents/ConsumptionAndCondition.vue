<template>
  <div class="grid bg-white rounded-lg p-5 gap-4 shadow-card">
    ...
    <div class="grid grid-cols-16">
      ...
      <div
        class="col-span-2 flex items-center text-blue-700 px-3 py-3 h-16 border-t border-l bg-gray-50 text-14"
      >
        {{ $t("me") }}
      </div>
      <div
      ...
      <div
        class="col-span-2 flex items-center text-blue-700 px-3 py-3 h-16 border-t border-x bg-gray-50 text-14"
      >
        {{ $t("remainOnBoard") }}
      </div>

      <div
        class="col-span-2 row-span-2 flex p-3 border-l border-t border-green-200 bg-green-100/50"
      >
        <div class="self-center text-green-800 text-12">
          {{ $t("fuelOilInMT") }}
        </div>
      </div>
      <div
        class="col-span-2 text-green-800 p-3 border-t border-l border-green-100 bg-green-25 text-14"
      >
        {{ $t("lsfo") }}
      </div>
      <input
        ...
        placeholder="0"
        class="col-span-2 p-3 pl-4 border-t border-l bg-white text-14 text-gray-700 focus:outline-0"
      />
      <input
      ...
      />
      <div
        class="col-span-2 text-gray-400 p-3 border-t border-l bg-gray-25 text-14"
      >
        {{ lsfo_total }}
      </div>
      <div
        class="col-span-2 text-gray-400 p-3 border-t border-x bg-gray-25 text-14"
      >
        {{ lsfo_rob }}
      </div>
      ...
      <div
        class="col-span-2 row-span-4 flex p-3 border-t border-l border-yellow-200 bg-yellow-100/50"
      >
        <div class="self-center text-yellow-800 text-12">
          {{ $t("lubricateOilInL") }}
        </div>
      </div>
      <div
        class="col-span-10 text-yellow-800 p-3 border-t border-l border-yellow-100 bg-yellow-25 text-14"
      >
        {{ $t("meCylinder") }}
      </div>
      <input
      ...
      <div
        class="col-span-2 row-span-2 flex p-3 border-y border-l border-blue-200 bg-sysblue-100/50"
      >
        <div class="self-center text-sysblue-800 text-12">
          {{ $t("freshWaterInTon") }}
        </div>
      </div>
      <div
        class="col-span-5 text-sysblue-800 p-3 border-t border-l border-sysblue-100 bg-sysblue-25 text-14"
      >
        {{ $t("consumed") }}
      </div>
      <div
      ...
      <div
        class="col-span-2 text-sysblue-800 p-3 border-t border-l border-sysblue-100 bg-sysblue-25 text-14"
      >
        +/-
      </div>
      <div
        class="col-span-2 text-sysblue-800 p-3 border-t border-x border-sysblue-100 bg-sysblue-25 text-14"
      >
        {{ $t("rob") }}
      </div>
      <input
        ...
        placeholder="0"
        class="col-span-5 p-3 pl-4 border-y border-l bg-white text-14 text-gray-700 focus:outline-0"
      />
      <input
      ...
      />
      <div
        class="col-span-2 text-gray-400 p-3 border-y border-l bg-gray-25 text-14"
      >
        {{ freshwater_change }}
      </div>
      <div
        class="col-span-2 text-gray-400 p-3 border-y border-x bg-gray-25 text-14"
      >
        {{ freshwater_rob }}
      </div>
    </div>
    ...
    <div class="grid grid-cols-8 border">
      ...
      <select
        ...
        :class="
          correction.type === 'default' ? 'text-gray-400' : 'text-gray-700'
        "
      >
      ...
      <div class="flex col-span-3 p-3 pl-4 border-l bg-white">
        <input
          v-model="correction.change"
          @keypress="preventNaN($event, correction.change)"
      ...
      <textarea
        v-model.trim="correction.remarks"
        placeholder="Input description here"
        class="col-span-6 row-span-2 border-t border-l p-3 pl-4 bg-white text-14 text-gray-700 focus:outline-0"
      ></textarea>
    </div>
  </div>
</template>
