        ...
        <div class="flex h-20 mx-12 items-center rounded-xl min-w-max z-10" :class="expanded?'bg-blue':'bg-white drop-shadow-md mb-6'">
            ...
            <div class="flex bg-gray-50 h-12 m-3 items-center rounded-xl w-full min-w-fit ml-20">
                <div class="flex justify-between items-center h-px bg-sysblue-800 ml-5 w-full mx-4 my-3">
                    ...
                    <CustomButton class="p-1 h-7 text-12 text-blue-800 min-w-fit rounded-xl z-10">
        ...
        <div v-show="expanded" class="min-h-fit bg-darkgray mx-12 mb-6 rounded-xl -mt-4 p-5">
            ...
            <div class="flex flex-col space-y-4"> 
                <div v-for="(report, index) in reports" :key="index">
                    <ReportCard :report_no="report.report_no" :report_type="report.report_type" :departure="report.departure" :arrival="report.arrival" :loading_condition="report.loading_condition" :date_of_submission="report.date_of_submission"></ReportCard>
                </div>
                <ReportCard report_no="DEPARTURE" report_type="DEPART" departure="Singapore" arrival="Ulsan" loading_condition="Westbound" date_of_submission="2022-10-19, 4:08 PM"></ReportCard>
                <!-- TEST ITEMS -->
