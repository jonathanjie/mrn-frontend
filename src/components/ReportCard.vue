<template>
    <div class="flex h-20 items-center justify-between rounded-xl min-w-max bg-gray-50">
        <img v-if="report_type==1" src="@/assets/icons/depart_report.svg" class="h-10 w-10 m-5"/>
        <img v-if="report_type==2" src="@/assets/icons/arrival_report.svg" class="h-10 w-10 m-5"/>
        ...
        <img v-if="report_type==2" src="@/assets/icons/arrival_icon.svg" class="m-5 mr-20"/>
        <img v-if="report_type==3" src="@/assets/icons/noon_icon.svg" class="m-5 mr-[86px]"/>
        <img v-if="report_type==4" src="@/assets/icons/bunker_icon.svg" class="m-5"/>
...
export default {
    ...
    props: {
        report_type: {
            type: Number, // TODO: enum - arrival/departure/noon/bunker
            required: false,
            default: 1
        },
        report_no: {
