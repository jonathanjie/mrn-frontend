...
const sendReport = async () => {
  ...
  const REPORT = {
    ...
    distanceperformancedata: {
      hours_since_noon: hoursSinceNoon,
      hours_total: hoursTotal,
      distance_to_go: "1000",
      remarks_for_changes: "No change",
      distance_obs_since_noon: distanceObsSinceNoon,
      distance_obs_total: distanceObsTotal,
      ...
      speed_since_noon: speedSinceNoon,
      rpm_since_noon: rpmSinceNoon,
      slip_since_noon: slipSinceNoon,
      speed_avg: speedAvg,
      rpm_avg: rpmAvg,
      slip_avg: slipAvg,
    },
    ...
    stoppagedata: {
      start_date:stoppageBeginning,
      end_date: stoppageEnding,
      duration: stoppageDuration,
      reduced_rpm: reducedRPM,
